      ...
      <div className="relative z-10 flex items-center w-full h-full">
        <div className="flex w-full">
          <div className="flex flex-col items-start w-1/2">
            <h1 id="hero-title" className="font-bold heroElement text-7xl">
            ...
            <div
              id="search-container"
              className="flex w-full max-w-xl p-3 mt-5 overflow-hidden bg-white rounded-full shadow-lg"
            >
              <input
                className="flex-auto p-2 text-lg border-none outline-none focus:ring-0"
                type="text"
                name="search"
                id="search"
              ...
              <button
                id="search-button"
                className="grid p-2 rounded-full bg-primary h-14 w-14 place-items-center"
              >
            ...
            <div className="mt-16">
              ...
              <div className="flex flex-wrap max-w-xl gap-3 mt-3">
                {keywords.map((item) => (
